...
namespace mu2e {
  ...
  // Extrapolation configuration
    struct KKExtrapConfig {
      ...
      fhicl::Atom<float> MinVLong { Name("MinVLong"), Comment("Minimum velocity perp to a CRV axis-normal (z-normal) end-cap plane (mm/ns); higher than MinV to suppress grazing-cosmic fakes on the end-caps"), 265.0f };
